...
export default function EpubReader({
    ...
    // Store callbacks in refs to avoid re-initializing the EPUB when callbacks change
    ...
    // DRM protection (screenshot, blur/focus, context menu) is handled by parent DrmWrapper
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- callbacks stored in refs to avoid re-initializing the entire EPUB
    }, [bookUri]);
